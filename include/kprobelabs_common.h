...
enum {
    ...
    KPROBELABS_FUNCINDEX_POLL,
    KPROBELABS_FUNCINDEX_MAX,
};

struct kmalloc_unit_args {
    int size;
    int bMalloc;
};
...
#define KPROBELABS_IOCTL_KMALLOC _IOC(_IOC_WRITE, KPROBELABS_IOCTL_MAGIC, KPROBELABS_FUNCINDEX_KMALLOC, sizeof(struct kmalloc_unit_args))
...
#define KPROBELABS_IOCTL_POLL _IOC(_IOC_WRITE, KPROBELABS_IOCTL_MAGIC, KPROBELABS_FUNCINDEX_POLL, sizeof(unsigned int))
